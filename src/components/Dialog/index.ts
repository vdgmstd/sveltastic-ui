...
/** Modal dialog. Compound: `Dialog.Root` + `Trigger`/`Content`/`Title`/`Description`/`Body`/`Footer`/`Close`. */
export const Dialog = { Root, Trigger, Content, Title, Description, Body, Footer, Close };
