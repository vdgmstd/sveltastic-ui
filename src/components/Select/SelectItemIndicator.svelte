<script lang="ts" module>
	...
	export type SelectItemIndicatorProps = WithElementRef<
...
<script lang="ts">
	...
	let { ref = $bindable(null), children, child, class: className, ...rest }: SelectItemIndicatorProps =
		$props();
	...
	const merged = $derived(
		mergeProps(rest, {
			class: cn('select__item-indicator', className),
			'aria-hidden': true,
