<script lang="ts" module>
	...
	export type TextareaMessageProps = WithElementRef<
...
<script lang="ts">
	...
	let { ref = $bindable(null), class: className, children, child, ...rest }: TextareaMessageProps =
		$props();
	...
	const merged = $derived(
		mergeProps(rest, {
			class: cn('textarea__message', className),
			id: ctx.messageId,
